...
import '../Arbeitszeitkonto/Ereignisbuchung.css'
import OneAPI from '../../api/OneAPI';
import ProjektarbeitereignisListEntry from './ProjektarbeitereignisListEntry'
import Alert from '@mui/material/Alert';
import Stack from '@mui/material/Stack';

export class Projektarbeitereignis extends Component {
  ...
  getEreignisbuchungIST = () => {
    OneAPI.getAPI().getEreignisbuchungIST(this.props.user, this.props.startFilter, this.props.endFilter).then(ereignisbuchungen =>
      this.setState({
  ...
  getEreignisbuchungSOLL = () => {
    OneAPI.getAPI().getEreignisbuchungSOLL(this.props.user, this.props.startFilter, this.props.endFilter).then(ereignisbuchungen =>
      this.setState({
      ...
      <div>
        ...
        <div>
          ...
          <div class="buchungDeleted" >
            ...
            {ereignisbuchungen ?
            ereignisbuchungen.map(ereignisbuchung => <ProjektarbeitereignisListEntry key={ereignisbuchung.getID()} ereignisbuchung={ereignisbuchung} istBuchung={true} ereignisbuchungIstDeleted={this.EreignisbuchungIstDeleted}/>):null}
        </div>
        : <div>
          ...
          <div class="buchungDeleted" >
            ...
            {ereignisbuchungenSoll ?
            ereignisbuchungenSoll.map(ereignisbuchung => <ProjektarbeitereignisListEntry key={ereignisbuchung.getID()} ereignisbuchung={ereignisbuchung} istBuchung={true} ereignisbuchungSollDeleted={this.EreignisbuchungIstDeleted}/> ):null}
          </div>}
      </div>
    )
  }
